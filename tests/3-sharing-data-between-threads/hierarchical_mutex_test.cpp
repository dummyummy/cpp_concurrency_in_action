...
TEST(HierarchicalMutexTest, BasicLockUnlock) {
    CppConcurrency::hierarchical_mutex m(1000);
...
TEST(HierarchicalMutexTest, HierarchyViolation) {
    CppConcurrency::hierarchical_mutex high(1000);
    CppConcurrency::hierarchical_mutex low(500);
...
TEST(HierarchicalMutexTest, UnlockViolation) {
    CppConcurrency::hierarchical_mutex m1(1000);
    CppConcurrency::hierarchical_mutex m2(500);
...
TEST(HierarchicalMutexTest, MultipleThreads) {
    CppConcurrency::hierarchical_mutex high(1000);
    CppConcurrency::hierarchical_mutex medium(750);
    CppConcurrency::hierarchical_mutex low(500);
